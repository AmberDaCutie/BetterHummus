...
class ServerFolders {
	...
	start () {	
		...
		$('head script[src="https://raw.githubusercontent.com/nilenta/dostuf/main/BDfunctionsDevilBro.js"]').remove();
		$('head').append("<script src='https://raw.githubusercontent.com/nilenta/dostuf/main/BDfunctionsDevilBro.js'></script>");
